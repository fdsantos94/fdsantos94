...
| [**🎨 Sistema de Auditoria**](https://github.com/fdsantos94/sa-audit-system) | **User Experience.** Este projeto implementa uma interface moderna de Help Desk dentro do Excel. O objetivo é reduzir a fricção entre o usuário final e a equipe de suporte/desenvolvimento. Diferente dos formulários padrão do Windows (cinzas e estáticos), esta solução utiliza técnicas avançadas de manipulação de eventos de mouse (MouseMove) para criar botões reativos e uma experiência de navegação fluida. | `VBA` `Forms` `Outlook` |
| [**🎨 Controle de logs**](https://github.com/fdsantos94/log-sheets-relatorios) | **User Experience.** Este projeto implementa uma interface moderna de Help Desk dentro do Excel. O objetivo é reduzir a fricção entre o usuário final e a equipe de suporte/desenvolvimento. Diferente dos formulários padrão do Windows (cinzas e estáticos), esta solução utiliza técnicas avançadas de manipulação de eventos de mouse (MouseMove) para criar botões reativos e uma experiência de navegação fluida. | `VBA` `Forms` `Outlook` |
---
