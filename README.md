...
| :--- | :--- | :---: |
| [**💰 Gestão de Reembolsos & Divergências**](https://github.com/fdsantos94/erros-de-pagamentos) | **People Ops & Compliance.** Sistema dedicado à auditoria e correção de descontos indevidos em folha de pagamento. Soluciona falhas geradas por erros operacionais ou ausência de tratativa dos gestores. O foco é garantir o ressarcimento ágil e justo ao colaborador, criando um fluxo padronizado e auditável para justificar cada estorno realizado. | `VBA` `Forms` `UX Design` |
